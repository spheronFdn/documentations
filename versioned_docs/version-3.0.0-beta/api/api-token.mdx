...
Before creating an access token for authentication, you need to sync your GitHub or GitLab account to give spheron access.
[Click here for more instructions about granting access to your repository](https://docs.spheron.network/deployments/deployment).
...
Setting an expiration date on an Access Token is highly recommended and is considered one of the standard security practices that helps keep your information secure. You can select from a default list of expiration dates ranging from 1 day to 1 year. You can view the expiration date of your Access Tokens on the [tokens page](https://app.spheron.network/#/user/settings/api-tokens).
