...
<strong>Step 1: </strong> Go to your project dashboard and click on the domain tab
as shown below

<img src={require("@site/static/img/3.0.0/pdb.png").default} />

<strong>Step 2:</strong> From the sidebar on the left-hand side panel, navigate to
your domain that you want to add in the registry

<img src={require("@site/static/img/3.0.0/prd.png").default} />

<strong>Step 3:</strong> Click on update on Secureon for any of your subdomains and
choose your preferred registry

<img src={require("@site/static/img/3.0.0/aso.png").default} />

<strong>Step 4:</strong> After selecting your preferred registry, click on add and
confirm notification prompt from metamask / your chosen wallet.

<img src={require("@site/static/img/3.0.0/msp.png").default} />

<strong>Step 5:</strong> After confirming the prompt, you will be redirected to a
page to show your successfully added domains.
